var Transaction = function (transaction_id, merchant, category, merchant_lat, merchant_long, amt, father){
...
for (let i = 0; i < 10; i++){
    var t =  new Transaction("id", "merchant", "category", "merchant_lat", "merchan_long", "amt", father)
}